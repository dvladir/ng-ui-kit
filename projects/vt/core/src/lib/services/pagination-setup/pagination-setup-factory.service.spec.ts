...
import {LocalPaginationConfig, PaginationData, RemotePaginationConfig, SortField} from '@vt/core';
import {Observable, of} from 'rxjs';
import {LocalPaginationSetup} from './local-pagination-setup';
import {PaginationSetup} from './pagination-setup';
import {RemotePaginationSetup} from './remote-pagination-setup';
